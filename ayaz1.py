...
----------------------------------------------
 ...
 Version   : 1.0.0
----------------------------------------------
 AMKING NEW Pro version 1.0.0
 For Haters: JUST SEE ANOTHER UPDATE  🤞
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        tks = ("Hi Amking Sir, I Need To Buy Your Paid AmKING PRO Tools Version 1.0.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
